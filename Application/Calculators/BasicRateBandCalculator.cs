namespace Application.Calculators
{
    public class BasicRateBandCalculator
    {
        ...
        /// <param name="adjustments">Adjustments such as pension contributions and gift aid contributions, which can be null.</param>
        /// <returns>The income within the basic rate band.</returns>
        public decimal Calculate(decimal taxableIncome, decimal basicRateThreshold, decimal? adjustments)
        {
            var adjustedThreshold = basicRateThreshold + (adjustments ?? 0);
