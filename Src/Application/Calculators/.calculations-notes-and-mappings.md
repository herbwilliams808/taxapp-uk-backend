...
### Income
``` 
A165() = { A141( NonSavingsIncome ) }
A165a() = min( A165(NonSavingsIncome), S2(StarterRateBand) )
```
#### Income in basic rate band (A166)
lower of (A165 minus A165a) and (S3 + A119)
``` 
A166(IncomeInBasicRateBand) = min( 
  A165(NonSavingsIncome) - A165a(),
...
``` 
A167(IncomeAboveBasicRateBand) = { 
  A165(NonSavingsIncome) + 
  A166(IncomeInBasicRateBand) }
```
